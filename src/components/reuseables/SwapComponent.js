...
// Send data function
  const renderItem = ({ item }) => (
    <TouchableOpacity onPress={()=>navigation.navigate(SCREEN.SingleItem)} style={styles.itemContainer}>
...
<Text style={{fontSize:14,fontFamily:FONT.Roboto_Medium,color:COLOR.black,marginTop:'5%'}}>{item.title}</Text>
<View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginTop:'4%',}}>
<Image style={{height:14,width:14}} source={item.person1}/>
<Text style={{fontSize:10,fontFamily:FONT.Roboto_Medium,color:COLOR.black}}>{item.name}</Text>
<Image style={{height:9,width:9}} source={require('../../Assets/images/Swap/star.png')}/>

<Text style={{fontSize:8,fontFamily:FONT.Roboto_Medium,color:COLOR.black}}>{item.rating}</Text>
...
<Text style={{fontSize:14,fontFamily:FONT.Roboto_Medium,color:COLOR.black,marginTop:'5%',alignSelf:'center'}}>{item.title2}</Text>
...
<Text style={{fontSize:10,fontFamily:FONT.Roboto_Medium,color:COLOR.black}}>{item.name2}</Text>
<Image style={{height:9,width:9}} source={require('../../Assets/images/Swap/star.png')}/>
...
const renderItemRecevied = ({ item }) => (
  <TouchableOpacity onPress={()=>navigation.navigate(SCREEN.SingleItem)} style={styles.itemContainerRe}>
 <View style={{flexDirection:'row',alignItems:'center',justifyContent:'space-between',marginHorizontal:"5%",marginTop:'5%'}}>
 <View style={{}}>
<Image style={{height:70,width:70,alignSelf:'center'}} source={item.image}/>
<Text style={{fontSize:14,fontFamily:FONT.Roboto_Medium,color:COLOR.black,marginTop:'5%'}}>{item.title}</Text>
...
<Button title={'Cancel'} ButtonContainer={styles.buttonContainercan} ButtonText={styles.buttontextcan}/>
...
<Text style={{fontSize:8,fontFamily:FONT.Roboto_Medium,color:COLOR.black}}>{item.rating}</Text>
 ...
 <Button title={'Rate Meal'} ButtonContainer={styles.buttonContainerComp} ButtonText={styles.buttontextComp} onPress={()=>setIsVisible(true)}/>
    ...
    >
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <Text style={styles.modalText}>Would you like to rate the order?</Text>
