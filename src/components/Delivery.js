...
const navigation = useNavigation()
  const renderItem = ({ item }) => (
    <TouchableOpacity activeOpacity={2} onPress={()=>navigation.navigate(SCREEN.SingleItem)} style={styles.itemContainer}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.menuRow}>
        <Text style={styles.menuText}>Explore Menu</Text>
