...
const navigation= useNavigation();
  ...
  return (
    <View style={styles.container}>
     ...
     <Text style={{fontSize:20,fontFamily:FONT.Urbanist_SemiBold,color:COLOR.black,alignSelf:"center",marginTop:"5%"}}>Select Your Location for Delvery</Text>
...
<Text style={{fontSize:16,fontFamily:FONT.Urbanist_Regular,color:COLOR.grey_1,marginLeft:'1%'}}>Raisanwalaa, Okara , punjab</Text>
    </View>
    <MapCheckbox/>
