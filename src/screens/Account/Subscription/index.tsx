    ...
    return (
        <View>
            <ImageBackground
                ...
                <TouchableOpacity onPress={()=>{navigation.navigate('')}} style={[styles.buttonContainer, { marginTop: 60 }]} >
                    <Text style={{ fontSize: 14, fontFamily: FONT.Urbanist_SemiBold, color: COLOR.black, fontWeight: '700' }}>Select Plan</Text>
                </TouchableOpacity>
            </ImageBackground>
            <View style={styles.Navigation}>
                <Image source={item.navigation} style={{width:60,height:8,resizeMode:'contain'}} />
            </View>
        </View>
    )
}
